...
export default function AllRepos() {
  ...
  const getLatestApiData = () => {
    ...
    getAllRepos(localStorage.getItem('currentTag'));
  };

  async function getAllRepos(tagName) {
    startSpinner();
  ...
  return (
    <Page title="All Repos | Repo Analyser">
      <Container>
